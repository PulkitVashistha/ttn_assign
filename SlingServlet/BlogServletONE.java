package com.tothenew.core.servlets;
...
@Component(service = Servlet.class,
        property = {
                ...
                "sling.servlet.resourceTypes=" + "/apps/tothenew/components/structure/pages/blog",
                "sling.servlet.selectors=" + "display",
                "sling.servlet.extensions=" + "html"
        })
public class BlogServletONE extends SlingSafeMethodsServlet {
